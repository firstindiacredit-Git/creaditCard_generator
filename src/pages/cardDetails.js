    ...
    <div className="flip-card-inner">
      <div className="flip-card-front-dd">
        ...
        <img className="logo"
          width="40"
          height="36"
          src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRboNjYTo07Tygm--nUmqwF0pipg4id90g1Ng&s' />
        {/* <p className="heading_8264">American Express</p> */}
        <p className="number">{card.Credit_Card_Number.match(/.{1,4}/g).join(' ')}</p>
        <p className="valid_thru1">valid thru</p>
        <p className="valid_thru">{card.Expiry_Date}</p>
...
const CardSearch = () => {
  ...
  return (
    <div className="" style={{marginTop:"3rem"}}>
      ...
      <form onSubmit={handleSearch} className="card-form" style={{boxShadow:"10rem"}}>
        ...
        <button type="submit" className="form-button" style={{backgroundColor:"#4c3575"}}>Search</button>
      </form>
